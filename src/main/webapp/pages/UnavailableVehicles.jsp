...
<title>Unavailable Vehicles</title>
<link rel="stylesheet" href="./UnavailableVehicles.css">
...
%>
<div class="content">
<h1>Unavailable Vehicle Details</h1>
</div>
<div class="links">
<form action="AdminProcess.do" method="post">
	<input type="hidden" name="Name" value="${requestScope.Name}" >
	<input class="box" type="submit" name="action" value="Modify Detail">
