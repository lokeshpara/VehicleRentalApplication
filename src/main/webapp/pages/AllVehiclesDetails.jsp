...
<link rel="stylesheet" href="./AllVehiclesDetails.css">
...
<form action="AdminProcess.do" method="post">
	...
	<input type="submit" class="box" name="action" value="Available Vehicles">

	<input type="submit"class="box" name="action" value="Unavailable Vehicles">

	<input type="submit"class="box" name="action" value="Add vehicles">
